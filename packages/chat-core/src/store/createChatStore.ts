...
// ponytail: configRef mimics React.RefObject ({ current }) so React callers pass llmRef directly;
// Arrow callers pass a plain object literal. RefObject import avoided to stay framework-free.
export const createChatStore = (configRef: { current: CreateChatStoreConfig }) => {
